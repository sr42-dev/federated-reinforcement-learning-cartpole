...
from conf.names import RLAlgorithmName, DeepLearningModelName

from main_constants import MODE_SYNCHRONIZATION, MODE_GRADIENTS_UPDATE, MODE_PARAMETERS_TRANSFER, \

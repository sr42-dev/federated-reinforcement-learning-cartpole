...
import rl_main.rl_utils, rl_utils
from chief_workers.chief import Chief
...
def on_chief_message(client, userdata, msg):
    ...
    if MODE_SYNCHRONIZATION:
        ...
        if len(chief.messages_received_from_workers[int(chief.episode_chief)]) == NUM_WORKERS - chief.NUM_DONE_WORKERS:
